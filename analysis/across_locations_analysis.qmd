...
rec_single <- ggplot(data = df_part, 
            aes(color = location, x = age, y = recognizability)) +
  geom_jitter(alpha = 0.15, size = 1.5, width = 0.1) +
...
ggsave(here("data/figures/recognizability_single.svg"), rec_single, bg="white", device="pdf", width=8, height=8)
rec_single
```
